...
class Cpcoder_Cms_Block_Adminhtml_Cms_Page_Grid_Renderer_Action
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    ...
    public function render(Varien_Object $row)
    {
        ...
        $getData = $row->getData();
        $message = Mage::helper('cpcoder_cms')->__('Are you sure you want to delete this page?');
        ...
        $delete = $this->getUrl('cpcoder_cms/adminhtml_cms_page/delete',array('page_id' => $pageID));
