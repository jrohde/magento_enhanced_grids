 ...
 */
class Cpcoder_Cms_Adminhtml_Cms_PageController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function massDeleteAction()
    {
        ...
        if(!is_array($pageIds)) {
            Mage::getSingleton('adminhtml/session')->addError(Mage::helper('cpcoder_cms')->__('Unable to find pages to delete.'));
        } else {
            try {
                ...
                foreach ($pageIds as $pageId) {
                    $pageModel->load($pageId)->delete();
                }
                Mage::getSingleton('adminhtml/session')->addSuccess(
                Mage::helper('cpcoder_cms')->__(
                'Total of %d record(s) were deleted.', count($pageIds)
                )
                );
            } catch (Exception $e) {
                Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
